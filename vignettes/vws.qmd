...
## User-Defined Regions {#sec-user-region}
...
## Rejection Sampling {#sec-r-rejection-sampling}
...
### `rejection` function {.unnumbered .unlisted}
...
log-scale.
5. A structure created from `univariate_helper`. See below.
6. Maximum number of regions to create in the proposal.
7. Desired bound for probability of rejection in the proposal.
8. An object constructed using `rejection_control`. See below.

### `rejection_control` function {.unnumbered .unlisted}
...
### `univariate_helper` function {.unnumbered .unlisted}

TBD: `univariate_helper`
