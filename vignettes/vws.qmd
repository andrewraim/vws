...
## Adapting the Proposal {#sec-adapt}
...
|`log_add2_exp(x, y)` | Compute $\log(e^x + e^y)$. If `x` and/or `y` is a vector, the functions produces a vector of corresponding results.|
