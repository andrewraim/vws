...
::: {.callout-caution title="TBD: move this"}
...
It looks like we can capture the distribution almost exactly by covering the entire support with a not-too-large choice of $N$, but this will depend on the parameters $\lambda$ and $\nu$. When we have refined to this point, it becomes extremely rare to reject any candidates.
