...
out = r_vmf_pre_v2(n = 1000, kappa = 5, d = 4, N = 50, tol = 0.10)
head(out$draws)
```
...
out = r_vmf_pre_v3(n = 1000, kappa = 5, d = 4, N = 50, tol = 0.10)
head(out$draws)
```
...
#| out-width: 60%
#| fig-cap: |
#|   Rate of refine improvement for VMF example with linear majorizer.
