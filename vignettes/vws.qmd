...
- Make a remark about passing large objects by value using `shared_ptr`. Make
  sure it actually works though.
...
- Note that we can capture by reference here if we need to, to avoid copying
  large objects
