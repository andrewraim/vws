...
date: now
date-format: "[Last modified:] YYYY-MM-DD HH:mm"
author:
...
<!-- -->
\begin{math}
w(y) = \frac{1}{y} \exp\left\{ -\frac{1}{2\sigma^2} (\log y - \mu)^2 \right\} \mathbb{1}_{(0,\infty)}(x),
\end{math}
<!-- -->
...
Method            Description
-----             -----
`w`               $w(x) = \frac{1}{y} \exp\left\{ -\frac{1}{2\sigma^2}
