...
The approach from @sec-persistent-module using Rcpp modules is used in @sec-ln-norm-within-gibbs to generate from an unfamiliar conditional within a Gibbs sampler.
...
# Example: Lognormal-Normal within Gibbs {#sec-ln-norm-within-gibbs}
